...
import { listCompanyContactsRoute } from './http/routes/list-company-contacts.js';
import { listReferralsRoute } from './http/routes/list-referrals.js';

export interface AppDeps {
  db: Database;
  sql: postgres.Sql;
  env: ReferralsServiceEnv;
  logger: Logger;
  broker: EventBroker;
